 ...
 */
@WebServlet("/CalendarMonthBusinessTetsuyaModeTimeOffServletUpdate")
public class CalendarMonthBusinessTetsuyaModeTimeOffServletUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/CalendarMonthBusinessTetsuyaModeTimeOffUpdate.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (pDao.update((String)session.getAttribute("number"),plan)) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/CalendarMonthBusinessTetsuyaModeTimeOffResult.jsp");
			dispatcher.forward(request, response);
