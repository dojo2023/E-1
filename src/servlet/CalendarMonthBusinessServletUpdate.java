 ...
 */
@WebServlet("/CalendarMonthBusinessServletUpdate")
public class CalendarMonthBusinessServletUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/CalendarMonthBusinessUpdate.jsp");
