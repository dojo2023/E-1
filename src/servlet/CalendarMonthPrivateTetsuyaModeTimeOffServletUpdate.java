 ...
 */
@WebServlet("/CalendarMonthPrivateTetsuyaModeTimeOffServletUpdate")
public class CalendarMonthPrivateTetsuyaModeTimeOffServletUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/CalendarMonthPrivateTetsuyaModeTimeOffUpdate.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String n = (String)session.getAttribute("number");

		if (pDao.update((String)session.getAttribute("number"),plan)) {
			// 登録成功
			request.setAttribute("result","更新完了");
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/CalendarMonthPrivateTetsuyaModeTimeOffResult.jsp");
			dispatcher.forward(request, response);
