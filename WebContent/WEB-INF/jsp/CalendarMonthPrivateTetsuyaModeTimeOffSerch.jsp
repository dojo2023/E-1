...
<div class ="register-area">
	...
	<form name="serch" action="CalendarMonthPrivateTetsuyaModeTimeOffSerchServlet" method="post">
	 ...
	 <form name="regist" action="CalendarMonthPrivateTetsuyaModeTimeOfServlet" method="get">
	...
	<c:forEach var="e" items="${serchList}" >
		<table class="list">
			...
			<tr>
				<form name="date" action="CalendarMonthPrivateTetsuyaModeTimeOfServletUpdate" method="get">
					<td><input type="submit" name="SUBMIT" value=${e.number}></td>
				</form>
				<form name="date" action="CalendarMonthPrivateTetsuyaModeTimeOfServletDelete" method="get">
				<td><input type="submit" name="SUBMIT" value=${e.number}></td>
				</form>
			</tr>
		</table>
