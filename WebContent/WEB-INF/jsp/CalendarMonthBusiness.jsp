...
<div class="area-mode">
	...
	<div class="tekitoutetuya">
  		...
  		<a href="http://localhost:8080/example/CalendarMonthTetsuyaChangeOnServlet"><img class="onImage" src="/AllNightCalender/img/徹夜モードon.png" alt="オンの画像" style="display: none;"></a>
